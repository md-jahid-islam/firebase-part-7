            ...
            <div className="main">
                ...
                <div className="main-form">
                    ...
                    <form onSubmit={handelSubmit} className='form'>
                        ...
                        {
                            loading? 
                            <div className='w-full h-[40px] flex justify-center items-center px-4 py-2 font-bold text-white bg-blue-800 rounded-full focus:outline-none focus:shadow-outline' ><BarLoader color='#fff' /></div>
                            :
                            <button type='submit' className='w-full px-4 py-2 font-bold text-white bg-blue-400 rounded-full hover:bg-blue-800 focus:outline-none focus:shadow-outline' >Login</button>
                        }
                        ...
                        <div className="from-text flex flex-col gap-1 items-center">
                            <Link to='/register' className="text-[12px] text-white align-baseline hover:text-blue-400">Create an Account!</Link>
                            <Link to='/resetpassword' className="text-[12px] text-white align-baseline hover:text-blue-300">Forgot Password?</Link>
                        </div>
