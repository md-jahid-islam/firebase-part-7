        ...
        <div className="container">
            <div className="main">
                ...
                <div className="main-form">
                    <h1 className=' text-[#6EACDA]'>Welcome</h1>
                    <form onSubmit={handelSubmit} className='form'>
                        ...
                        {/* buttom  */}
                        {
                            ...
                            :
                            <button type='submit' className='w-full px-4 py-2 font-bold text-white bg-blue-700 rounded-full hover:bg-blue-700 focus:outline-none focus:shadow-outline' >Register</button>
                        }
                        ...
                        <div className="from-text flex flex-col gap-1 items-center">
                            <Link to='/login' className="text-[12px] text-white align-baseline">Already have an Account! <span className=' bg-[#E3A5C7]'>Login</span> </Link>
                        </div>
